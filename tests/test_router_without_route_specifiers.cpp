...
class RouterWithoutRouteSpecifiers : public ::testing::Test,
...
public:
    ...
    void operator()(const std::string& chapterName, int pageIndex, const Request&, Response& response)
    {
