...
namespace without_request_type_and_response_value {

class RouterWithoutRequestTypeAndResponseValue : public ::testing::Test,
public whaleroute::RequestRouter<Request, Response, whaleroute::_, RequestProcessor> {
public:
...
TEST_F(RouterWithoutRequestTypeAndResponseValue, StatelessRouteProcessor)
{
...
TEST_F(RouterWithoutRequestTypeAndResponseValue, StatefulRouteProcessor)
{
    NameState state;
...
TEST_F(RouterWithoutRequestTypeAndResponseValue, ChainedRouteProcessor)
{
    NameState state;
    auto processor = StatefulRouteProcessor{state};
...
TEST_F(RouterWithoutRequestTypeAndResponseValue, TemplateProcessorInMultipleRoutes)
{
    int state = 0;
