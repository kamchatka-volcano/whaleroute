...
//    struct RouteSpecificationPredicate<RouteAccess, TRequest, TResponse> {
//        bool operator()(RouteAccess value, const TRequest& request, TResponse&) const
//        {
...
//                            public whaleroute::RequestRouter<Request, Response, whaleroute::_, ResponseValue> {
//public:
//    AccessTestingRouter()
//    {
//    }
...
//    }
//
//    std::function<void(const Request&, Response& response)> makeProcessor(
//            std::function<void(const Request&, Response& response)> processor)
//    {
